import{L as e,S as t,v as n}from"./ApiController-Dkzl_Sne.js";import{n as r,u as i}from"./wui-text-CN6pFnQ8.js";import{n as a,o,r as s}from"./utils-DNdqbV_P.js";import{a as c,t as l,u}from"./lit-DYLA5iLF.js";import{c as d,l as f}from"./class-map-B3oaB8hb.js";import"./wui-icon-Cw1NwGez.js";var p=s({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=e({state:p,subscribe(e){return o(p,()=>e(p))},subscribeKey(e,t){return a(p,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=u`
  :host {
    width: 100%;
    display: block;
  }

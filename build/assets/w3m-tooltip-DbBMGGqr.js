import{L as e,S as t,v as n}from"./ApiController-DWi1j6U-.js";import{n as r,u as i}from"./wui-text-B21XdOMr.js";import{_ as a,a as o,m as s,p as c,t as l,u}from"./lit-uSiIg7ms.js";import{c as d,l as f}from"./class-map-DSBKZWiD.js";import"./wui-icon-DDivCPlS.js";var p=s({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=e({state:p,subscribe(e){return a(p,()=>e(p))},subscribeKey(e,t){return c(p,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=u`
  :host {
    width: 100%;
    display: block;
  }

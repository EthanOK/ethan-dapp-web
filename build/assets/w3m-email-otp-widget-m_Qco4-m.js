import{A as e,B as t,N as n,_ as r,y as i}from"./ModalController-CURGdslE.js";import{a,i as o,n as s,s as c,u as l}from"./wui-text-Dsh7F1Eu.js";import{a as u,t as d,u as f}from"./lit-DYLA5iLF.js";import{c as p,l as m}from"./class-map-B3oaB8hb.js";import"./wui-link-CIX8DKzb.js";import"./wui-loading-spinner-CeEzVM4X.js";var h=l`
  :host {
    position: relative;
...
`,g=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},_=class extends d{constructor(){super(...arguments),this.disabled=!1,this.value=``}render(){return u`<input
      type="number"
      maxlength="1"
      inputmode="numeric"
      autofocus
...
`,S=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},C,w=C=class extends d{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=n.getTimeToNextEmailLogin(),this.error=``,this.otp=``,this.email=i.state.data?.email,this.authConnector=r.getAuthConnector()}render(){if(!this.email)throw Error(`w3m-email-otp-widget: No email provided`);let e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return u`
      <wui-flex
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=n.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=n.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(e){try{this.loading||(this.otp=e.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await this.onOtpSubmit?.(this.otp)))}catch(e){this.error=t.parseError(e),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){if(this.error=``,this.otp=``,!r.getAuthConnector()||!this.email)throw Error(`w3m-email-otp-widget: Unable to resend email`);this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),e.showSuccess(`Code email resent`)}}else this.onStartOver&&this.onStartOver()}catch(t){e.showError(t)}finally{this.loading=!1}}getFooterLabels(e){return this.onStartOver?{title:`Something wrong?`,action:`Try again ${e?`in ${this.timeoutTimeLeft}s`:``}`}:{title:`Didn't receive it?`,action:`Resend ${e?`in ${this.timeoutTimeLeft}s`:`Code`}`}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===C.OTP_LENGTH}};w.OTP_LENGTH=6,w.styles=x,S([p()],w.prototype,`loading`,void 0),S([p()],w.prototype,`timeoutTimeLeft`,void 0),S([p()],w.prototype,`error`,void 0),w=C=S([s(`w3m-email-otp-widget`)],w);export{w as t};
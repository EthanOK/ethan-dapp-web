import{B as e,E as t,H as n,R as r,S as i,V as a,_ as o,b as s,g as c,l,r as u,t as d,v as f}from"./ApiController-q6XFwN9I.js";import{S as p,_ as m,b as h,m as g,o as _,v,y}from"./wui-text-ClkJTVHD.js";import{n as b,r as x,t as S}from"./wui-list-social-BCFqExuk.js";import"./react-Dwk2zAKa.js";import{t as C}from"./AlertController-CghHluOT.js";import{t as w}from"./wui-loading-thumbnail-BmcXgmx_.js";import"./wui-button-D_UKyDSp.js";import"./wui-icon-BL-soNCX.js";import"./wui-icon-box-CYylOe1U.js";import{t as T}from"./ConstantsUtil-BMeCb4uS.js";var E=g`
  :host {
...
`,D=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},O=class extends h{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=c.state.connectors,this.authConnector=this.connectors.find(e=>e.type===`AUTH`),this.remoteFeatures=r.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=d.state.plan.hasExceededUsageLimit,this.unsubscribe.push(c.subscribeKey(`connectors`,e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>e.type===`AUTH`)}),r.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[],t=!!this.authConnector,r=e?.length,a=i.state.view===`ConnectSocials`;return(!t||!r)&&!a?null:(a&&!r&&(e=n.DEFAULT_SOCIALS),p` <wui-flex flexDirection="column" gap="2">
      ${e.map(e=>p`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){i.push(`UsageExceeded`);return}e&&await b(e)}async handlePwaFrameLoad(){if(e.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof x&&await this.authConnector.provider.init()}catch(e){C.open({displayMessage:`Error loading embedded wallet in PWA`,debugMessage:e.message},`error`)}finally{this.isPwaLoading=!1}}}};O.styles=E,D([y()],O.prototype,`tabIdx`,void 0),D([v()],O.prototype,`connectors`,void 0),D([v()],O.prototype,`authConnector`,void 0),D([v()],O.prototype,`remoteFeatures`,void 0),D([v()],O.prototype,`isPwaLoading`,void 0),D([v()],O.prototype,`hasExceededUsageLimit`,void 0),O=D([_(`w3m-social-login-list`)],O);var k=g`
  wui-flex {
...
`,A=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},j=class extends h{constructor(){super(),this.unsubscribe=[],this.checked=w.state.isLegalCheckboxChecked,this.unsubscribe.push(w.subscribeKey(`isLegalCheckboxChecked`,e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=r.state,n=r.state.features?.legalCheckbox,i=!!(e||t)&&!!n&&!this.checked,a=i?-1:void 0;return p`
      ...
      >
        <w3m-social-login-list tabIdx=${m(a)}></w3m-social-login-list>
      </wui-flex>
    `}};j.styles=k,A([v()],j.prototype,`checked`,void 0),j=A([_(`w3m-connect-socials-view`)],j);var M=g`
  wui-logo {
    width: 80px;
    height: 80px;
...
`,I=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},L=class extends h{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=u.getAccountData()?.socialProvider,this.uri=u.getAccountData()?.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=r.state.remoteFeatures,this.authConnector=c.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(u.subscribeChainProp(`accountState`,e=>{this.socialProvider=e?.socialProvider,this.uri=e?.farcasterUrl,this.connectFarcaster()}),r.subscribeKey(`remoteFeatures`,e=>{this.remoteFeatures=e})),window.addEventListener(`resize`,this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener(`resize`,this.forceUpdate),!u.state.activeCaipAddress&&this.socialProvider&&(this.uri||this.loading)&&s.sendEvent({type:`track`,event:`SOCIAL_LOGIN_CANCELED`,properties:{provider:this.socialProvider}})}render(){return this.onRenderProxy(),p`${this.platformTemplate()}`}platformTemplate(){return e.isMobile()?p`${this.mobileTemplate()}`:p`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?p`${this.loadingTemplate()}`:p`${this.qrTemplate()}`}qrTemplate(){return p` <wui-flex
    ...
    >`}onRenderProxy(){!this.ready&&this.uri&&(this.timeout=setTimeout(()=>{this.ready=!0},200))}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let e=this.getBoundingClientRect().width-40,t=o.state.themeVariables[`--apkt-qr-color`]??o.state.themeVariables[`--w3m-qr-color`];return p` <wui-qr-code
      size=${e}

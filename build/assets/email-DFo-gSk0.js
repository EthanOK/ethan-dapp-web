import{B as e,E as t,R as n,S as r,b as i,g as a,l as o,r as s,ut as c,v as l}from"./ApiController-BspwwenT.js";import{A as u,P as d,h as f,l as p,z as m}from"./SolanaStoreUtil-BfqeOKJ6.js";import{s as h}from"./wui-text-BBxkFcIb.js";import"./wui-button-Dtm3kduT.js";import{t as g}from"./ConstantsUtil-BzVOL_Q_.js";import"./wui-link-Y7lQpR9d.js";import{t as _}from"./w3m-email-otp-widget-C4H9CIXo.js";import"./wui-icon-box-BJ4i1INt.js";import{n as v,t as y}from"./ref-CSmfitxF.js";import"./wui-email-input-FvWJl25Z.js";var b=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},x=class extends _{constructor(){super(...arguments),this.onOtpSubmit=async a=>{try{if(this.authConnector){let e=s.state.activeChain,c=o.getConnections(e),u=n.state.remoteFeatures?.multiWallet,d=c.length>0;if(await this.authConnector.provider.connectOtp({otp:a}),i.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_PASS`}),e)await o.connectExternal(this.authConnector,e);else throw Error(`Active chain is not set on ChainController`);if(n.state.remoteFeatures?.emailCapture)return;if(n.state.siwx){l.close();return}if(d&&u){r.replace(`ProfileWallets`),t.showSuccess(`New Wallet Added`);return}l.close()}}catch(t){throw i.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_FAIL`,properties:{message:e.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),i.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_SENT`}))}}};x=b([p(`w3m-email-verify-otp-view`)],x);var S=f`
  wui-icon-box {
    height: ${({spacing:e})=>e[16]};
    width: ${({spacing:e})=>e[16]};
  }
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w=class extends u{constructor(){super(),this.email=r.state.data?.email,this.authConnector=a.getAuthConnector(),this.loading=!1,this.listenForDeviceApproval()}render(){if(!this.email)throw Error(`w3m-email-verify-device-view: No email provided`);if(!this.authConnector)throw Error(`w3m-email-verify-device-view: No auth connector provided`);return d`
      <wui-flex
...
`,E=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},D=class extends u{constructor(){super(...arguments),this.formRef=y(),this.initialEmail=r.state.data?.email??``,this.redirectView=r.state.data?.redirectView,this.email=``,this.loading=!1}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,e=>{e.key===`Enter`&&this.onSubmitEmail(e)})}render(){return d`
    ...
    `}onEmailInputChange(e){this.email=e.detail}async onSubmitEmail(e){try{if(this.loading)return;this.loading=!0,e.preventDefault();let t=a.getAuthConnector();if(!t)throw Error(`w3m-update-email-wallet: Auth connector not found`);let n=await t.provider.updateEmail({email:this.email});i.sendEvent({type:`track`,event:`EMAIL_EDIT`}),n.action===`VERIFY_SECONDARY_OTP`?r.push(`UpdateEmailSecondaryOtp`,{email:this.initialEmail,newEmail:this.email,redirectView:this.redirectView}):r.push(`UpdateEmailPrimaryOtp`,{email:this.initialEmail,newEmail:this.email,redirectView:this.redirectView})}catch(e){t.showError(e),this.loading=!1}}buttonsTemplate(){let e=!this.loading&&this.email.length>3&&this.email!==this.initialEmail;return this.redirectView?d`
      <wui-flex gap="3">

import{B as e,N as t,R as n,S as r,b as i,h as a,r as o,u as s}from"./ApiController-BspwwenT.js";import{A as c,P as l,V as u,h as d,l as f,m as p,u as m}from"./SolanaStoreUtil-BfqeOKJ6.js";import{c as h,o as g,s as _}from"./wui-text-BBxkFcIb.js";import"./wui-image-DTFkqfdE.js";import"./wui-icon-box-BHp4Aw-V.js";import"./wui-shimmer-4p7pwMCx.js";import"./wui-link-Y7lQpR9d.js";import"./wui-icon-box-BJ4i1INt.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=d`
  :host > wui-flex {
    display: flex;
...
`,b=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},x=class extends c{constructor(){super(...arguments),this.images=[],this.secondImage={type:void 0,url:``},this.failedImageUrls=new Set}handleImageError(e){return t=>{t.stopPropagation(),this.failedImageUrls.add(e),this.requestUpdate()}}render(){let[e,t]=this.images;this.images.length||(this.dataset.noImages=`true`);let n=e?.type===`NFT`,r=t?.url?t.type===`NFT`:n,i=n?`var(--apkt-borderRadius-3)`:`var(--apkt-borderRadius-5)`,a=r?`var(--apkt-borderRadius-3)`:`var(--apkt-borderRadius-5)`;return this.style.cssText=`
    ...
    `:null}getDirectionIcon(){switch(this.direction){case`in`:return`arrowBottom`;case`out`:return`arrowTop`;default:return}}getIcon(){return this.onlyDirectionIcon?this.getDirectionIcon():this.type===`trade`?`swapHorizontal`:this.type===`approve`?`checkmark`:this.type===`cancel`?`close`:this.getDirectionIcon()}getStatusColor(){switch(this.status){case`confirmed`:return`success`;case`failed`:return`error`;case`pending`:return`inverse`;default:return`accent-primary`}}};x.styles=[y],b([h()],x.prototype,`type`,void 0),b([h()],x.prototype,`status`,void 0),b([h()],x.prototype,`direction`,void 0),b([h({type:Boolean})],x.prototype,`onlyDirectionIcon`,void 0),b([h({type:Array})],x.prototype,`images`,void 0),b([h({type:Object})],x.prototype,`secondImage`,void 0),b([_()],x.prototype,`failedImageUrls`,void 0),x=b([f(`wui-transaction-visual`)],x);var S=d`
  :host {
    width: 100%;
  }
...
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w=class extends c{constructor(){super(...arguments),this.type=`approve`,this.onlyDirectionIcon=!1,this.images=[]}render(){return l`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
    ...
    `}templateDescription(){let e=this.descriptions?.[0];return e?l`
        ...
        `:null}};w.styles=[p,S],C([h()],w.prototype,`type`,void 0),C([h({type:Array})],w.prototype,`descriptions`,void 0),C([h()],w.prototype,`date`,void 0),C([h({type:Boolean})],w.prototype,`onlyDirectionIcon`,void 0),C([h()],w.prototype,`status`,void 0),C([h()],w.prototype,`direction`,void 0),C([h({type:Array})],w.prototype,`images`,void 0),w=C([f(`wui-transaction-list-item`)],w);var T=d`
  wui-flex {
    position: relative;
    display: inline-flex;
    justify-content: center;
...
`,E=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},D={sm:`xxs`,lg:`md`},O=class extends c{constructor(){super(...arguments),this.type=`approve`,this.size=`lg`,this.statusImageUrl=``,this.images=[]}render(){return l`<wui-flex>${this.templateVisual()} ${this.templateIcon()}</wui-flex>`}templateVisual(){switch(this.dataset.size=this.size,this.type){case`trade`:return this.swapTemplate();case`fiat`:return this.fiatTemplate();case`unknown`:return this.unknownTemplate();default:return this.tokenTemplate()}}swapTemplate(){let[e,t]=this.images;return this.images.length===2&&(e||t)?l`
    ...
    ></wui-icon>`}getTemplateIcon(){return this.type===`trade`?`arrowClockWise`:`arrowBottom`}};O.styles=[T],E([h()],O.prototype,`type`,void 0),E([h()],O.prototype,`size`,void 0),E([h()],O.prototype,`statusImageUrl`,void 0),E([h({type:Array})],O.prototype,`images`,void 0),O=E([f(`wui-transaction-thumbnail`)],O);var k=d`
  :host > wui-flex:first-child {
    gap: ${({spacing:e})=>e[2]};
...
`,A=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},j=class extends c{render(){return l`
    ...
    `}};j.styles=[p,k],j=A([f(`wui-transaction-list-item-loader`)],j);var M=d`
  :host {
    min-height: 100%;
  }

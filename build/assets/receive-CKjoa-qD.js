import{A as e,B as t,T as n,g as r,r as i,v as a,y as o,z as s}from"./ModalController-CURGdslE.js";import{a as c,i as l,n as u,s as d,u as f}from"./wui-text-Dsh7F1Eu.js";import{a as p,t as m}from"./lit-DYLA5iLF.js";import{c as h,l as g,s as _}from"./class-map-B3oaB8hb.js";import"./wui-image-BbqNNDNb.js";import"./wui-qr-code-hx7jfVmT.js";var v=f`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`,S=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},C=class extends m{constructor(){super(),this.unsubscribe=[],this.address=i.getAccountData()?.address,this.profileName=i.getAccountData()?.profileName,this.network=i.state.activeCaipNetwork,this.unsubscribe.push(i.subscribeChainProp(`accountState`,t=>{t?(this.address=t.address,this.profileName=t.profileName):e.showError(`Account not found`)}),i.subscribeKey(`activeCaipNetwork`,e=>{e?.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw Error(`w3m-wallet-receive-view: No account provided`);let e=n.getNetworkImage(this.network);return p` <wui-flex
    ...
    </wui-flex>`}networkTemplate(){let e=i.getAllRequestedCaipNetworks(),t=i.checkIfSmartAccountEnabled(),a=i.state.activeCaipNetwork,o=e.filter(e=>e?.chainNamespace===a?.chainNamespace);if(r(a?.chainNamespace)===s.ACCOUNT_TYPES.SMART_ACCOUNT&&t)return a?p`<wui-compatible-network
        @click=${this.onReceiveClick.bind(this)}
        text="Only receive assets on this network"
        .networkImages=${[n.getNetworkImage(a)??``]}
      ></wui-compatible-network>`:null;let c=(o?.filter(e=>e?.assets?.imageId)?.slice(0,5)).map(n.getNetworkImage).filter(Boolean);return p`<wui-compatible-network
      @click=${this.onReceiveClick.bind(this)}

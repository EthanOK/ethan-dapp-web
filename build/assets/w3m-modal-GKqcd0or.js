import{E as e,F as t,P as n,R as r,S as i,_ as a,b as o,g as s,l as c,r as l,s as u,t as d,v as f}from"./ApiController-q6XFwN9I.js";import{S as p,T as ee,_ as m,b as h,c as g,d as _,h as v,l as te,m as y,o as b,u as ne,v as x,y as S}from"./wui-text-ClkJTVHD.js";import{r as C}from"./wui-list-wallet-aaz9y5lg.js";import{t as re}from"./SwapController-IKQTGQ9m.js";import{t as w}from"./AlertController-CghHluOT.js";import"./w3m-tooltip-Bx5NdPr2.js";import"./wui-loading-spinner-BDdsXmKd.js";import"./wui-button-D_UKyDSp.js";import"./wui-icon-BL-soNCX.js";import{n as T}from"./exports-DhQ02mdd.js";import"./wui-image-BrNBkMiY.js";import"./wui-icon-box-BahcoKje.js";import{t as E}from"./HelpersUtil-BU0iQ7Nb.js";import{t as D}from"./ConstantsUtil-BMeCb4uS.js";var O={isUnsupportedChainView(){return i.state.view===`UnsupportedChain`||i.state.view===`SwitchNetwork`&&i.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){f.shake();return}if(await C.isSIWXCloseDisabled()){f.shake();return}(i.state.view===`DataCapture`||i.state.view===`DataCaptureOtpConfirm`)&&c.disconnect(),f.close()}},ie=y`
  :host {
    display: block;

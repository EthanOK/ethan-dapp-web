import{A as e,B as t,T as n,l as r,r as i,y as a}from"./ModalController-C4AqAtvU.js";import{a as o,n as s,s as c,u as l}from"./wui-text-Dsh7F1Eu.js";import{a as u,t as d}from"./lit-DYLA5iLF.js";import{c as f,l as p,s as m}from"./class-map-B3oaB8hb.js";import{L as h}from"./index-C3z1q16l.js";import"./wui-image-uFUtsk7l.js";import"./wui-input-amount-CjOgOCXt.js";var g=l`
  button {
    border: none;
...
`,k=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},A=class extends d{constructor(){super(),this.unsubscribe=[],this.assets=h.state.assets,this.search=``,this.onDebouncedSearch=t.debounce(e=>{this.search=e}),this.unsubscribe.push(h.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u`
    ...
    `}onBuyClick(){a.push(`OnRampProviders`)}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){h.setPaymentAsset(e),a.goBack()}};A.styles=O,k([f()],A.prototype,`assets`,void 0),k([f()],A.prototype,`search`,void 0),A=k([s(`w3m-deposit-from-exchange-select-asset-view`)],A);export{A as W3mDepositFromExchangeSelectAssetView,D as W3mDepositFromExchangeView};
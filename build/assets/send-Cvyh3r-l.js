import{B as e,E as t,H as n,I as r,P as i,S as a,b as o,c as s,ct as c,i as l,l as u,nt as d,r as f,v as p}from"./ApiController-q6XFwN9I.js";import{S as m,_ as h,b as g,c as _,d as v,l as y,m as b,o as x,v as S,y as C}from"./wui-text-ClkJTVHD.js";import"./react-Dwk2zAKa.js";import{t as w}from"./SwapController-IKQTGQ9m.js";import"./wui-button-D_UKyDSp.js";import"./wui-icon-BL-soNCX.js";import"./wui-image-BrNBkMiY.js";import"./wui-separator-5UvWPvHU.js";import"./wui-link-t5qIMC1u.js";import"./wui-icon-box-CYylOe1U.js";import{n as T,t as E}from"./ref-4Qp0IR1H.js";import"./wui-input-amount-Ck02ad1A.js";import"./wui-token-button-B_cbBU9z.js";var D=b`
  :host {
    width: 100%;
    height: 100px;
...
`,O=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},k=class extends g{constructor(){super(...arguments),this.inputElementRef=E(),this.instructionElementRef=E(),this.readOnly=!1,this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=e.debounce(async t=>{if(!t.length){this.setReceiverAddress(``);return}let n=f.state.activeChain;if(e.isAddress(t,n)){this.setReceiverAddress(t);return}try{let e=await u.getEnsAddress(t);if(e){l.setReceiverProfileName(t),l.setReceiverAddress(e);let n=await u.getEnsAvatar(t);l.setReceiverProfileImageUrl(n||void 0)}}catch{this.setReceiverAddress(t)}finally{l.setLoading(!1)}})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return this.readOnly?m` <wui-flex
    ...
    >
      ...
      <textarea
        ...
        autocomplete="off"
      ></textarea>
    </wui-flex>`}async focusInput(){this.instructionElementRef.value&&(this.instructionHidden=!0,await this.toggleInstructionFocus(!1),this.instructionElementRef.value.style.pointerEvents=`none`,this.inputElementRef.value?.focus(),this.inputElementRef.value&&(this.inputElementRef.value.selectionStart=this.inputElementRef.value.selectionEnd=this.inputElementRef.value.value.length))}async focusInstruction(){this.instructionElementRef.value&&(this.instructionHidden=!1,await this.toggleInstructionFocus(!0),this.instructionElementRef.value.style.pointerEvents=`auto`,this.inputElementRef.value?.blur())}async toggleInstructionFocus(e){this.instructionElementRef.value&&await this.instructionElementRef.value.animate([{opacity:+!e},{opacity:+!!e}],{duration:100,easing:`ease`,fill:`forwards`}).finished}onBoxClick(){!this.value&&!this.instructionHidden&&this.focusInput()}onBlur(){!this.value&&this.instructionHidden&&!this.pasting&&this.focusInstruction()}checkHidden(){this.instructionHidden&&this.focusInput()}async onPasteClick(){this.pasting=!0;let e=await navigator.clipboard.readText();l.setReceiverAddress(e),this.focusInput()}onInputChange(e){let t=e.target;this.pasting=!1,this.value=e.target?.value,t.value&&!this.instructionHidden&&this.focusInput(),l.setLoading(!0),this.onDebouncedSearch(t.value)}setReceiverAddress(e){l.setReceiverAddress(e),l.setReceiverProfileName(void 0),l.setReceiverProfileImageUrl(void 0),l.setLoading(!1)}};k.styles=D,O([C()],k.prototype,`value`,void 0),O([C({type:Boolean})],k.prototype,`readOnly`,void 0),O([S()],k.prototype,`instructionHidden`,void 0),O([S()],k.prototype,`pasting`,void 0),k=O([x(`w3m-input-address`)],k);var A=b`
  :host {
    width: 100%;
    height: 100px;
    border-radius: ${({borderRadius:e})=>e[5]};
...
`,j=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},M=class extends g{constructor(){super(...arguments),this.readOnly=!1,this.isInsufficientBalance=!1}render(){let e=this.readOnly||!this.token;return m` <wui-flex
    ...
    </wui-flex>`}onInputChange(e){l.setTokenAmount(String(e.detail))}onMaxClick(){if(this.token){let e=Number(this.token.quantity.decimals),t=c.bigNumber(this.token.quantity.numeric);if(!this.token.address&&this.gasPrice){let n=65000n*BigInt(this.gasPrice),r=c.bigNumber(n.toString()).div(c.bigNumber(10).pow(e)),i=t.minus(r);l.setTokenAmount(i.gt(0)?i.toFixed(e,0):`0`)}else l.setTokenAmount(t.toFixed(e,0))}}};M.styles=A,j([C({type:Object})],M.prototype,`token`,void 0),j([C({type:Boolean})],M.prototype,`readOnly`,void 0),j([C({type:String})],M.prototype,`sendTokenAmount`,void 0),j([C({type:Boolean})],M.prototype,`isInsufficientBalance`,void 0),j([C({type:String})],M.prototype,`gasPrice`,void 0),M=j([x(`w3m-input-token`)],M);var N=b`
  :host {
    display: block;
  }
...
`,R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},z=class extends g{constructor(){super(),this.unsubscribe=[],this.tokenBalances=l.state.tokenBalances,this.search=``,this.onDebouncedSearch=e.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(l.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return m`
    ...
    `}async fetchBalancesAndNetworkPrice(){(!this.tokenBalances||this.tokenBalances?.length===0)&&(await this.fetchBalances(),await this.fetchNetworkPrice())}async fetchBalances(){await l.fetchTokenBalance(),l.fetchNetworkBalance()}async fetchNetworkPrice(){await w.getNetworkTokenPrice()}templateSearchInput(){return m`
    ...
    `}templateTokens(){return this.tokens=this.tokenBalances?.filter(e=>e.chainId===f.state.activeCaipNetwork?.caipNetworkId),this.search?this.filteredTokens=this.tokenBalances?.filter(e=>e.name.toLowerCase().includes(this.search.toLowerCase())):this.filteredTokens=this.tokens,m`
      <wui-flex
    ...
    `}onBuyClick(){a.push(`OnRampProviders`)}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){l.setToken(e),l.setTokenAmount(void 0),a.goBack()}};z.styles=L,R([S()],z.prototype,`tokenBalances`,void 0),R([S()],z.prototype,`tokens`,void 0),R([S()],z.prototype,`filteredTokens`,void 0),R([S()],z.prototype,`search`,void 0),z=R([x(`w3m-wallet-send-select-token-view`)],z);var B=b`
  :host {
    height: 32px;
    display: flex;
    align-items: center;

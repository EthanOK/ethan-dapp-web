import{A as e,B as t,C as n,H as r,S as i,V as a,_ as o,j as s,l as c,r as l,t as u,v as d,y as f}from"./ModalController-C4AqAtvU.js";import{n as p,u as m}from"./wui-text-Dsh7F1Eu.js";import{a as h,t as g}from"./lit-DYLA5iLF.js";import{c as _,l as v,s as y}from"./class-map-B3oaB8hb.js";import{t as b}from"./ConstantsUtil-BMeCb4uS.js";import{I as x,P as S,R as C,U as w,z as T}from"./index-C3z1q16l.js";var E=m`
  :host {
...
`,D=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},O=class extends g{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=o.state.connectors,this.authConnector=this.connectors.find(e=>e.type===`AUTH`),this.remoteFeatures=s.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=i.state.plan.hasExceededUsageLimit,this.unsubscribe.push(o.subscribeKey(`connectors`,e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>e.type===`AUTH`)}),s.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[],t=!!this.authConnector,n=e?.length,i=f.state.view===`ConnectSocials`;return(!t||!n)&&!i?null:(i&&!n&&(e=r.DEFAULT_SOCIALS),h` <wui-flex flexDirection="column" gap="2">
      ${e.map(e=>h`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){f.push(`UsageExceeded`);return}e&&await x(e)}async handlePwaFrameLoad(){if(t.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof w&&await this.authConnector.provider.init()}catch(e){T.open({displayMessage:`Error loading embedded wallet in PWA`,debugMessage:e.message},`error`)}finally{this.isPwaLoading=!1}}}};O.styles=E,D([v()],O.prototype,`tabIdx`,void 0),D([_()],O.prototype,`connectors`,void 0),D([_()],O.prototype,`authConnector`,void 0),D([_()],O.prototype,`remoteFeatures`,void 0),D([_()],O.prototype,`isPwaLoading`,void 0),D([_()],O.prototype,`hasExceededUsageLimit`,void 0),O=D([p(`w3m-social-login-list`)],O);var k=m`
  wui-flex {
...
`,A=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},j=class extends g{constructor(){super(),this.unsubscribe=[],this.checked=C.state.isLegalCheckboxChecked,this.unsubscribe.push(C.subscribeKey(`isLegalCheckboxChecked`,e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=s.state,n=s.state.features?.legalCheckbox,r=!!(e||t)&&!!n&&!this.checked,i=r?-1:void 0;return h`
    ...
    `}};j.styles=k,A([_()],j.prototype,`checked`,void 0),j=A([p(`w3m-connect-socials-view`)],j);var M=m`
  wui-logo {
    width: 80px;
    height: 80px;
...
`,I=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},L=class extends g{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=l.getAccountData()?.socialProvider,this.uri=l.getAccountData()?.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=s.state.remoteFeatures,this.authConnector=o.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(l.subscribeChainProp(`accountState`,e=>{this.socialProvider=e?.socialProvider,this.uri=e?.farcasterUrl,this.connectFarcaster()}),s.subscribeKey(`remoteFeatures`,e=>{this.remoteFeatures=e})),window.addEventListener(`resize`,this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener(`resize`,this.forceUpdate),!l.state.activeCaipAddress&&this.socialProvider&&(this.uri||this.loading)&&n.sendEvent({type:`track`,event:`SOCIAL_LOGIN_CANCELED`,properties:{provider:this.socialProvider}})}render(){return this.onRenderProxy(),h`${this.platformTemplate()}`}platformTemplate(){return t.isMobile()?h`${this.mobileTemplate()}`:h`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?h`${this.loadingTemplate()}`:h`${this.qrTemplate()}`}qrTemplate(){return h` <wui-flex
    ...
    >`}onRenderProxy(){!this.ready&&this.uri&&(this.timeout=setTimeout(()=>{this.ready=!0},200))}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let e=this.getBoundingClientRect().width-40,t=d.state.themeVariables[`--apkt-qr-color`]??d.state.themeVariables[`--w3m-qr-color`];return h` <wui-qr-code
      size=${e}

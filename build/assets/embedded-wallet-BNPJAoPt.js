import{B as e,E as t,H as n,N as r,O as i,Q as a,R as o,S as s,_ as c,b as l,g as u,h as d,i as f,l as p,r as m,ut as h,v as g}from"./ApiController-q6XFwN9I.js";import{S as _,T as v,_ as y,b,d as x,l as S,m as C,o as w,v as T,y as E}from"./wui-text-ClkJTVHD.js";import{t as D}from"./NavigationUtil-CLCRNDHF.js";import{p as O}from"./react-Dwk2zAKa.js";import"./wui-loading-spinner-BDdsXmKd.js";import"./wui-button-D_UKyDSp.js";import"./wui-icon-BL-soNCX.js";import"./wui-icon-link-DjAHof-N.js";import"./wui-image-BrNBkMiY.js";import"./wui-loading-spinner-BJ8w7rfh.js";import"./wui-link-t5qIMC1u.js";import"./wui-icon-box-CYylOe1U.js";import{n as k,t as A}from"./ref-4Qp0IR1H.js";import"./wui-input-text-BYZdZpv9.js";import{t as j}from"./HelpersUtil-BU0iQ7Nb.js";var ee=v`
  div {
    width: 100%;
  }
...
`,R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},z={sm:`md-regular`,md:`lg-regular`,lg:`lg-regular`},te={success:`sealCheck`,error:`warning`,warning:`exclamationCircle`},B=class extends b{constructor(){super(...arguments),this.type=`success`,this.size=`md`,this.imageSrc=void 0,this.disabled=!1,this.href=``,this.text=void 0}render(){return _`
    ...
    `}};V=ne([w(`w3m-upgrade-wallet-view`)],V);var H=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},U=class extends b{constructor(){super(...arguments),this.loading=!1,this.switched=!1,this.text=``,this.network=m.state.activeCaipNetwork}render(){return _`
...
`,Z=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Q=class extends b{constructor(){super(),this.formRef=A(),this.usubscribe=[],this.name=``,this.error=``,this.loading=O.state.loading,this.suggestions=O.state.suggestions,this.profileName=m.getAccountData()?.profileName,this.onDebouncedNameInputChange=e.debounce(e=>{e.length<4?this.error=`Name must be at least 4 characters long`:j.isValidReownName(e)?(this.error=``,O.getSuggestions(e)):this.error=`The value is not a valid username`}),this.usubscribe.push(O.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),m.subscribeChainProp(`accountState`,e=>{this.profileName=e?.profileName,e?.profileName&&(this.error=`You already own a name`)}))}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener(`keydown`,this.onEnterKey.bind(this))}render(){return _`
      <wui-flex
    ...
    `}submitButtonTemplate(){let e=this.suggestions.find(e=>e.name?.split(`.`)?.[0]===this.name&&e.registered);if(this.loading)return _`<wui-loading-spinner
        ...
        color="secondary"
      ></wui-loading-spinner>`;let t=`${this.name}${h.WC_NAME_SUFFIX}`;return _`
      <wui-icon-link
        ?disabled=${!!e}

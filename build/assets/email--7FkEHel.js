import{B as e,E as t,R as n,S as r,b as i,g as a,l as o,r as s,rt as c,v as l}from"./ApiController-Bge9ZqNt.js";import{n as u,u as d}from"./wui-text-CeHitJWk.js";import{a as f,t as p,u as m}from"./lit-uSiIg7ms.js";import{c as h}from"./class-map-DSBKZWiD.js";import"./react-Dce9Roo_.js";import"./wui-button-CvfPV-UR.js";import{t as g}from"./ConstantsUtil-BAVr3ZSM.js";import"./wui-link-BKDeACME.js";import{t as _}from"./w3m-email-otp-widget-XxMS304Q.js";import"./wui-icon-box-s-EfjWKE.js";import{n as v,r as y}from"./browser-C0nnMl-X.js";var b=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},x=class extends _{constructor(){super(...arguments),this.onOtpSubmit=async a=>{try{if(this.authConnector){let e=s.state.activeChain,c=o.getConnections(e),u=n.state.remoteFeatures?.multiWallet,d=c.length>0;if(await this.authConnector.provider.connectOtp({otp:a}),i.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_PASS`}),e)await o.connectExternal(this.authConnector,e);else throw Error(`Active chain is not set on ChainController`);if(n.state.remoteFeatures?.emailCapture)return;if(n.state.siwx){l.close();return}if(d&&u){r.replace(`ProfileWallets`),t.showSuccess(`New Wallet Added`);return}l.close()}}catch(t){throw i.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_FAIL`,properties:{message:e.parseError(t)}}),t}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),i.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_SENT`}))}}};x=b([u(`w3m-email-verify-otp-view`)],x);var S=d`
  wui-icon-box {
    height: ${({spacing:e})=>e[16]};
    width: ${({spacing:e})=>e[16]};
  }
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w=class extends p{constructor(){super(),this.email=r.state.data?.email,this.authConnector=a.getAuthConnector(),this.loading=!1,this.listenForDeviceApproval()}render(){if(!this.email)throw Error(`w3m-email-verify-device-view: No email provided`);if(!this.authConnector)throw Error(`w3m-email-verify-device-view: No auth connector provided`);return f`
      <wui-flex
...
`,E=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},D=class extends p{constructor(){super(...arguments),this.formRef=v(),this.initialEmail=r.state.data?.email??``,this.redirectView=r.state.data?.redirectView,this.email=``,this.loading=!1}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,e=>{e.key===`Enter`&&this.onSubmitEmail(e)})}render(){return f`
